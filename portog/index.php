...
-->
    <head>
        <meta charset="UTF-8">
<meta name="description" content="Omnifood is a premium online food ordering service bringing affordable and healthy food to as many as possible">
        
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>RESPONSIVE PORTOFLIO SITE | OUT OF THE BOX</title>
    ...
    <link type="text/css" rel="stylesheet" href="vendors/css/normalize.css">
        ...
        <link href="vendors/css/animate.min.css" rel="stylesheet" type="text/css">
        <link type="text/css" rel="stylesheet" href="resources/css/stylex.css">        
...
<!--    FEATURE SECTION-->
    <section class="section-features js--section-features" id="features">
        ...
        <div class="row js--wp-1">
            ...
            <i class="fa fa-calendar fa-4x icon-big"></i>
<!--            <i class="ion-ios-time-outline icon-big"></i>-->
            ...
            <div class="col span-1-of-4 box">
            <i class="fa fa-clock-o fa-4x icon-big"></i>
            ...
            <div class="col span-1-of-4 box">
                <i class="fa fa-delicious fa-4x icon-big"></i>
                <h3>100% organic</h3>
            ...
            <div class="col span-1-of-4 box">
            <i class="fa fa-cart-plus fa-4x icon-big"></i>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2 steps-box">
                <div class="works-step">
                    <div>1</div>
                    <p>Choose the subscription plan that fits your needs and sign up.</p>
                </div>
...
<!--    CITIES SECTION-->
    ...
    <div class="row">
        ...
        <div class="row js--wp-3"> 
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/london.jpg" alt="London UK">
                <h3>London</h3>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-3">
                ...
                I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                    <cite><img src="resources/img/customer-3.jpg" alt="Third Customer"> 
                        Milton Chapman</cite>
                </blockquote>
            </div>
            ...
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite><img src="resources/img/customer-2.jpg" alt="Second Customer"> 
                        Joana Silva </cite>
                </blockquote>
            </div>
            ...
            <div class="col span-1-of-3">
                  ...
                  Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!
                    <cite><img src="resources/img/customer-1.jpg" alt="First Customer"> 
                        Alberto Duncan </cite>
                </blockquote>
            </div>     
        </div>
...
<!--    CONTACT FORM SECTION-->
    ...
    <div class="map-box">
        ...
        <div class="row">    
            ...
            <div class="row">
                <form method="post" action="http://www.fgck96elections.com/portog/mailer.php" class="contact-form">
                    <div class="row">
    ...
    <footer>
        ...
        <div class="row">
        <p>
            Copyright &copy; 2015 - <?php echo date('Y'); ?> by Maverick. All Rights Reserved.        
        </p>
        </div>
    </footer>
    ...
    <script type="text/javascript" src="vendors/js/jquery-1.js"></script>
    <script type="text/javascript" src="vendors/js/jquery.waypoints.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCyIqwhZ9ZuChP3TZPPFJtE67fFfX1mrUs&callback=initMap" async defer></script>
...
<!--    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>    -->
    ...
    <script type="text/javascript" src="//cdn.jsdelivr.net/selectivizr/1.0.3b/selectivizr.min.js" ></script>  <!--all for IE browsers-->
